...
function buildPrompt(talk, coreOnly = false) {
...
function buildFixPrompt(talk, fixCtx, coreOnly = false) {
    const descSource = talk.contentDir
        ? `项目描述文件在目录：${talk.contentDir}
请先用 Read 工具读取该目录下的所有 .md 文件，了解完整的项目描述。`
        : `项目描述如下：
...
export async function execute(talk, cli, timeout, logDir, coreOnly = false, fixCtx) {
    let tmpDir;
